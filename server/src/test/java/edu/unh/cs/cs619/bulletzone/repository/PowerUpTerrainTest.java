...
public class PowerUpTerrainTest {
    ...
    public void setUp() throws Exception {
        ...
        repo.setMapPath("PowerUpTerrainTest.json");
    ...
    public void pickupAntiGravTestMovementInHillsTest() throws Exception {
        ...
        when(mockClock.millis()).thenReturn((long)1624);
        Assert.assertEquals(repo.move(tank.getId(), Direction.Up), 0);
        when(mockClock.millis()).thenReturn((long)1626);
        Assert.assertEquals(repo.move(tank.getId(), Direction.Up), 1);
    }
